      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
        ...
        <form onSubmit={handleSubmit} className="bg-surface-container-lowest rounded-2xl p-6 lg:p-8 shadow-card space-y-4">
          ...
          <InquiryImageUpload
            ...
            description="Upload logos, inspiration photos, packaging references, or brand guidelines."
            helperText="Clear brand files help us match colors, logo placement, and presentation."
          />
