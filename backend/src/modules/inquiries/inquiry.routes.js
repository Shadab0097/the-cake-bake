...
router.post('/custom-cake', optionalAuth, upload.array('referenceImages', 5), upload.verifyImageMagicBytes, validate(inquiryValidation.customCakeInquiry), inquiryController.submitCustomCake);
router.post('/corporate', upload.array('referenceImages', 5), upload.verifyImageMagicBytes, validate(inquiryValidation.corporateInquiry), inquiryController.submitCorporate);
